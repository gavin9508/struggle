package com.struggle.base.javaBase;
...
public class FileUtil {
    ...
    public static void main(String[] args) {
        String path = getPathByClassLoader("com/struggle/base/javaBase/reflects/classInfo.properties");
        System.out.println(path);
        path = getPathByClass("com/struggle/base/javaBase/reflects/classInfo.properties");
        System.out.println(path);
    }
}
